...
RSpec.describe Coupon, type: :model do
  ...
  it { is_expected.to validate_numericality_of(:discount_value).is_greater_than_or_equal_to(0) }

  it "can't have past date dua_date" do 
    subject.due_date = 1.day.ago
    subject.valid?
    expect(subject.errors.attribute_names).to include :due_date
  end

  it "can't with current date dua_date" do 
  ...
  it_behaves_like "name searchable concern", :coupon, :code
